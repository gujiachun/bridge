 ...
 * @author gujiachun
 */
public abstract class AbsTargetFactory implements TargetFactory {

    protected static final Logger logger = LoggerFactory.getLogger(AbsTargetFactory.class);

    protected Map<Integer, Object> targetMap;
    ...
    public void initTarget(TargetConn targetConn) {
        ...
        Object o = initTargetConn(targetConn);
    ...
    @Override
    public Object getTarget(Integer targetId) {
        if (targetMap == null){
            return null;
        }
    ...
    */
     ...
     *@param taskId
     *@return java.util.List<com.rainbow.bridge.server.model.target.TargetConn>
    */
    ...
    */
    protected abstract Object initTargetConn(TargetConn targetConn);
}
