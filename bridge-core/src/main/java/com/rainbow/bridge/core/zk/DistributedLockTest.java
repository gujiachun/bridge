...
public class DistributedLockTest {
    ...
    private static void simpleDistributedLockImplTest() {
        ...
        final ZkClientExt zkClientOne = new ZkClientExt("127.0.0.1:2181", 5000, 5000, new BridgeZkSerializer());
        final SimpleDistributedLockImpl sdliOne = new SimpleDistributedLockImpl(zkClientOne, "/locker");

        final ZkClientExt zkClientTwo = new ZkClientExt("127.0.0.1:2181", 5000, 5000, new BridgeZkSerializer());
        ...
        try {
            for (int i=0;i<5;i++) {
                ...
                Thread threadOne = new Thread(() -> {
                    try {
                        System.out.println("zkClientTwo 尝试获取锁...");
                        sdliTwo.acquire();
                        Thread.sleep(5000);
    ...
    private static void distributedLockImplTest() {
        // 分别创建两个客户端，并获取两个SimpleDistributedLockImpl实例
        //final ZkClientExt zkClientOne = new ZkClientExt("127.0.0.1:2181", 5000, 5000, new BytesPushThroughSerializer());
