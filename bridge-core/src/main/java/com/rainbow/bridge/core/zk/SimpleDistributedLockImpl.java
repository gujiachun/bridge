...
public class SimpleDistributedLockImpl extends BaseDistributedLock implements DistributedLock {
    ...
    public String getLockerNodePath() {
        return lockerNodePath;
    }

    public String getFinalCurrentNodePath() {
     ...
     *            /locker节点路径
     */
    public SimpleDistributedLockImpl(ZkClientExt client, String lockerNodePath) {
